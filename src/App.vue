<template>
  <div id="main" :class="isDay ? 'day' : 'night'">
    <div class="container my-6" style="max-width: 450px; min-width: 360px">
      <h5 class="title text-center">Weather Forecast</h5>
      ...
      >
        ...
        <div class="card-body">
          ...
          <div class="card-mid">
            <div class="row">
              <div class="col-12 text-center ">
                <span style="font-size: 25px;">{{ weather.temperature }}&deg;C</span>
                <p class="des" style="">{{ weather.description }}</p>
                <div class="date" style="">{{ dateBuilder() }}</div>
              </div>
            </div>
            <div class="row" style="margin-top: 20px">
              <div class="col d-flex justify-content-between px-5 mx-5">
                <p>
                  <img style="margin-bottom: 10px" src="./assets/down.svg" alt="" />
                  {{ weather.lowTemp }}&deg;C
                </p>
                <p>
                  <img style="margin-bottom: 10px"  src="./assets/up.svg" alt="" />
          ...
          <div style="margin-top: 20px; border-width: 2px; border-color: white">
            
            <div class="col text-center" style="width: 33%; float: left; font-size: 15px">
              <p>{{ weather.humidity}} %</p>
              <span>Humidity</span>
            </div>
            <div class="col text-center" style="width: 34%; float: left; font-size: 15px">
...
export default {
  ...
  methods: {
    getWeather: async function () {
      ...
      const key = "7f40938131da6e5fe5ebeaea4fe2d0da";
